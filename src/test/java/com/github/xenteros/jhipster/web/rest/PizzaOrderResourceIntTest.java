...
public class PizzaOrderResourceIntTest {
    ...
    public void createPizzaOrder() throws Exception {
        ...
        restPizzaOrderMockMvc.perform(post("/api/pizza-orders")
            ...
            .content(TestUtil.convertObjectToJsonBytes(pizzaOrderDTO)))
    ...
    public void testEntityFromId() {
        assertThat(pizzaOrderMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(pizzaOrderMapper.fromId(null)).isNull();
    }
}
